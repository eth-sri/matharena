...
uv run python arxivmath/fulltext_review.py  --false --model-config gemini/gemini-31-pro-medium --key ai_generated --prompt arxivmath/prompts/prompt_ai_detection.md
